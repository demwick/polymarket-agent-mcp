...
describe("handleListWatchlist", () => {
  ...
  it("returns empty message when watchlist is empty", () => {
    const result = handleListWatchlist(db);
    expect(result).toContain("empty");
  });

  it("renders watchlist as markdown table", () => {
  ...
  it("handles null alias gracefully", () => {
